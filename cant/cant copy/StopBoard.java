...
public class StopBoard extends JFrame implements ActionListener, MouseListener{
    ...
    */
    ...
    public void placeRunners(ArrayList<Integer> rollVals, JButton button){
        ...
        turnStatusLabel.setText("Advance a runner in your columns!");
    }

    public void endOrRoll(){
        turnStatusLabel.setText("End your Turn or Roll Again");
        rollValues.clear();
        boardColumns.get(column1-2).deactivateColumn();
        boardColumns.get(column2-2).deactivateColumn();
        column1 = 0;
        column2 = 0;
        rollBox.removeAll();
        turnStatusLabel.setText("Advance a runner in your columns!");
